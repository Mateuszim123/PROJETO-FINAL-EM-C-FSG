//Projeto criado a partir de um curso que fiz, com ideia de juntar alguns dos exercicios que tive dentro do mesmo! Programa conta com funções, matrizes, else if, while, switch / case,
// Na main do programa, temos a seleção de qual programa o usuario ira querer executar. Apos escolher caira para a função switch / case para ver qual opção usuario escolheu.
// Apos cair para a seleção de qual programa ele ira querer executar, ele puxara as funções de cada "PROGRAMA", para imprimir o resultado na tela!
